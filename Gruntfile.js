  ...
  grunt.initConfig({
    ...
    less: {
      ...
      bootstrap: {
        ...
        dest: "dist/bootstrap/css/bootstrap.css",
      },
      fontawesome: {
        options: {
          sourceMapURL: "fontawesome.css.map",
          sourceMapFilename: "dist/fontawesome/css/fontawesome.css.map",
        },
        src: "less/bootstrap.less",
        dest: "dist/fontawesome/css/fontawesome.css",
      },
      // theme: {
      //   options: {
    ...
    postcss: {
      ...
      bootstrap: {
        src: "dist/bootstrap/css/bootstrap.css",
      },
      fontawesome: {
        src: "dist/fontawesome/css/fontawesome.css",
      },
      // theme: {
    ...
    cssmin: {
      ...
      bootstrap: {
        src: "dist/bootstrap/css/bootstrap.css",
        dest: "dist/bootstrap/css/bootstrap.min.css",
      },
      fontawesome: {
        src: "dist/fontawesome/css/fontawesome.css",
        dest: "dist/fontawesome/css/fontawesome.min.css",
      },
      // theme: {
      //   src: "dist/css/<%= pkg.name %>-theme.css",
